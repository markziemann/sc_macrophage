...
alv_gfpneg1 <- colSums(P239_Alv_MDM_h3[1:21,])/colSums(P239_Alv_MDM_h3)*1e6
alv_gfpneg2 <- colSums(P239_Alv_MDM_h6[1:21,])/colSums(P239_Alv_MDM_h6)*1e6
alv_gfpneg3 <- colSums(M239_N239_Alv_h3[1:21,])/colSums(M239_N239_Alv_h3)*1e6
alv_gfpneg4 <- colSums(M239_N239_Alv_h6[1:21,])/colSums(M239_N239_Alv_h6)*1e6
...
#vioplot(gfp,horizontal=TRUE)
par(mar=c(7.1, 4.1, 4.1, 2.1))

lgfp <- lapply(gfp,function(x) { log10(x+1) } )
boxplot(lgfp,col="white",cex=0,las=2,border="darkgray",ylab="log10 RPM HIV")
beeswarm(lgfp,add=TRUE,pch=1,cex=0.1)

par(mar=c(5.1, 4.1, 4.1, 2.1))

mdm_latent1 <- gex1_h4_d0[,which(colSums(gex1_h4_d0[1:21,])/colSums(gex1_h4_d0)*1e6>=10)] #MDMP236 latent
mdm_bystander1 <- gex1_h4_d0[,which(colSums(gex1_h4_d0[1:21,])/colSums(gex1_h4_d0)*1e6<10)] #MDMP236 bystander

mdm_latent2 <- gex1_h4_d1[,which(colSums(gex1_h4_d1[1:21,])/colSums(gex1_h4_d1)*1e6>=10)] #MDMV236 latent
mdm_bystander2 <- gex1_h4_d1[,which(colSums(gex1_h4_d1[1:21,])/colSums(gex1_h4_d1)*1e6<10)] #MDMV236 bystander

mdm_latent3 <- gex2_h4[,which(colSums(gex2_h4[1:21,])/colSums(gex2_h4)*1e6>=10)] #MDMO236 latent
mdm_bystander3 <- gex2_h4[,which(colSums(gex2_h4[1:21,])/colSums(gex2_h4)*1e6<10)] #MDMO236 bystander

alv_latent1 <- P239_Alv_MDM_h3[,which(colSums(P239_Alv_MDM_h3[1:21,])/colSums(P239_Alv_MDM_h3)*1e6>=10)] #MDMP239 latent
alv_bystander1 <- P239_Alv_MDM_h3[,which(colSums(P239_Alv_MDM_h3[1:21,])/colSums(P239_Alv_MDM_h3)*1e6<10)] #MDMP239 bystander

alv_latent2 <- P239_Alv_MDM_h6[,which(colSums(P239_Alv_MDM_h6[1:21,])/colSums(P239_Alv_MDM_h6)*1e6>=10)] #AlvP239 latent
alv_bystander2 <- P239_Alv_MDM_h6[,which(colSums(P239_Alv_MDM_h6[1:21,])/colSums(P239_Alv_MDM_h6)*1e6<10)] #AlvP239 bystander

alv_latent3 <- M239_N239_Alv_h3[,which(colSums(M239_N239_Alv_h3[1:21,])/colSums(M239_N239_Alv_h3)*1e6>=10)] #AlvM239 latent
alv_bystander3 <- M239_N239_Alv_h3[,which(colSums(M239_N239_Alv_h3[1:21,])/colSums(M239_N239_Alv_h3)*1e6<10)] #AlvM239 bystander

alv_latent4 <- M239_N239_Alv_h6[,which(colSums(M239_N239_Alv_h6[1:21,])/colSums(M239_N239_Alv_h6)*1e6>=10)] #AlvN239 latent
alv_bystander4 <- M239_N239_Alv_h6[,which(colSums(M239_N239_Alv_h6[1:21,])/colSums(M239_N239_Alv_h6)*1e6<10)] #AlvN239 bystander
