...
```{r,de1m_nw,fig.width=9,fig.height=6, dev="svg"}
...
```{r,de1a_nw,fig.width=9,fig.height=6, dev="svg"}
...
```{r,de2m_nw,fig.width=9,fig.height=6, dev="svg"}
...
```{r,de2a_nw,fig.width=9,fig.height=6,dev="svg"}
...
```{r,de3m_nw,fig.width=9,fig.height=6,dev="svg"}
...
```{r,de3a_nw,fig.width=9,fig.height=6,dev="svg"}
...
pdf("de3_mm_mitchheat.pdf",height=7,width=7)
heatmap.2(as.matrix(mx),scale="none",trace="none",margins=c(6,25),
  col=colfunc(25),cexRow=0.75,cexCol=0.8)
mtext("DE3: mock vs productive (top discordant)")
dev.off()
...
```{r,de4m_nw,fig.width=9,fig.height=6,dev="svg"}
...
```{r,de4a_nw,fig.width=9,fig.height=6,dev="svg"}
